...
@Component({
  selector: 'app-resultOther1',
  templateUrl: './resultOther1.component.html',
  styleUrls: ['./resultOther1.component.scss']
})
export class ResultOther1Component implements OnInit {
  ...
  constructor(public _storageService: StorageService,
              public service1: FormulaOtherService,
