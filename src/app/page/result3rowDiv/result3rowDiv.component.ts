...
@Component({
  selector: 'app-result3rowDiv',
  templateUrl: './result3rowDiv.component.html',
  styleUrls: ['./result3rowDiv.component.scss']
})
export class Result3rowDivComponent implements OnInit {
